...
const CreateInvoiceService = async (req) => {
  //----Step 01: Calculate Total Payable And Vat.....//

  let user_id = new ObjectID(req.headers.user_id);
  let cus_mail = req.headers.email;
  ...
  let cus_details = `Name:${Profile[0].cus_name},Email:${Profile[0].cus_email},Address:${Profile[0].cus_add},
                     Phone:${Profile[0].cus_phone}`;
  let ship_details = `Name:${Profile[0].ship_name},City:${Profile[0].ship_city},Address:${Profile[0].ship_add},
